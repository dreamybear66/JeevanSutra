...
export default function PatientHistory() {
  ...
  const handlePatientSelect = async (patient) => {
    ...
    // Only show mock history for demo/seed patients. 
    // New patients registered in staff dashboard will show "No History Found".
    const demoPatients = ['Rajesh Kumar', 'Meena Devi', 'Amit Singh', 'Demo Test Patient'];
    
    if (demoPatients.includes(patient.name)) {
      setHistoryData({
      ...
      setHistoryData(null); // No history for new patients
    }
  };
        ...
        <div className="history-section fade-in">
          ...
          {!historyData ? (
            <div className="glass-card" style={{ padding: '48px', textAlign: 'center', color: 'var(--text-secondary)' }}>
              ...
              <p>This patient appears to be newly registered or has no previous admissions recorded in the system.</p>
            </div>
          ) : (
            <>
